...
import com.skanders.commons.convert.FromNode;
import com.skanders.commons.convert.Mapper;
...
public class Config
{
    ...
    {
        return FromNode.toArray(configTree, path, classType);
    }
    ...
    {
        return FromNode.toReqArray(configTree, path, classType);
    }
