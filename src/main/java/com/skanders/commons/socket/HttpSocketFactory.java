...
public class HttpSocketFactory
{
     ...
     */
    public static HttpSocketFactory createFactory(URI uri, MediaType requestType)
    {
     ...
     * @return an instance of ServiceSocketFactory
     */
    public static HttpSocketFactory createFactory(String uri, MediaType requestType)
    {
